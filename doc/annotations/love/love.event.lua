...
Event = {
    ...
    ["focus"] = 1,
    ---LoveJoystick pressed
    ["joystickpressed"] = 2,
    ---LoveJoystick released
    ["joystickreleased"] = 3,
    ---Key pressed
    ["keypressed"] = 4,
    ---Key released
    ...
    ["threaderror"] = 12,
    ---LoveJoystick connected
    ["joystickadded"] = 13,
    ---LoveJoystick disconnected
    ["joystickremoved"] = 14,
    ---LoveJoystick axis motion
    ["joystickaxis"] = 15,
    ---LoveJoystick hat pressed
    ["joystickhat"] = 16,
    ---LoveJoystick's virtual gamepad button pressed
    ["gamepadpressed"] = 17,
    ---LoveJoystick's virtual gamepad button released
    ["gamepadreleased"] = 18,
    ---LoveJoystick's virtual gamepad axis moved
    ["gamepadaxis"] = 19,
    ---User entered text
    ["textinput"] = 20,
    ...
    ["directorydropped"] = 28,
    ---LoveFile is dragged and dropped onto the window.
    ["filedropped"] = 29,
    ---LoveJoystick pressed
    ["jp"] = 30,
    ---LoveJoystick released
