...
-- region LoveDroppedFile
---@class LoveDroppedFile
---Represents a file dropped onto the window.
---
---Note that the LoveDroppedFile type can only be obtained from love.filedropped callback, and can't be constructed manually by the user.
local LoveDroppedFile = {}
-- endregion LoveDroppedFile
-- region LoveFile
---@class LoveFile
---Represents a file on the filesystem. A function that takes a file path can also take a LoveFile.
local LoveFile = {}
---Closes a LoveFile.
---@return boolean
...
function LoveFile:getBuffer()
end

---Gets the filename that the LoveFile object was created with. If the file object originated from the love.filedropped callback, the filename will be the full platform-dependent file path.
---@return string
function LoveFile:getFilename()
end

---Gets the FileMode the file has been opened with.
---@return FileMode
function LoveFile:getMode()
end

---Returns the file size.
---@return number
function LoveFile:getSize()
end

---Gets whether end-of-file has been reached.
---@return boolean
function LoveFile:isEOF()
end

---Gets whether the file is open.
---@return boolean
function LoveFile:isOpen()
end

---Iterate over all the lines in a file.
---@return function
function LoveFile:lines()
end

---Open the file for write, read or append.
---@param mode FileMode @The mode to open the file in.
---@return boolean, string
function LoveFile:open(mode)
end

---Read a number of bytes from a file.
---@param bytes number @The number of bytes to read.
---@return string, number
---@overload fun(container:ContainerType, bytes:number):LoveFileData or string, number
function LoveFile:read(bytes)
end

---Seek to a position in a file
---@param pos number @The position to seek to
---@return boolean
function LoveFile:seek(pos)
end
...
---
---LoveFile:flush will force any buffered data to be written to the disk.
---@param mode BufferMode @The buffer mode to use.
---@param size number @The maximum size in bytes of the file's buffer.
---@return boolean, string
function LoveFile:setBuffer(mode, size)
end

---Returns the position in the file.
---@return number
function LoveFile:tell()
end
...
---@return boolean, string
---@overload fun(data:LoveData, size:number):boolean, string
function LoveFile:write(data, size)
end

-- endregion LoveFile
-- region LoveFileData
---@class LoveFileData
---LoveData representing the contents of a file.
local LoveFileData = {}
---Gets the extension of the LoveFileData.
---@return string
function LoveFileData:getExtension()
end

---Gets the filename of the LoveFileData.
---@return string
function LoveFileData:getFilename()
end

-- endregion LoveFileData
---Buffer modes for LoveFile objects.
BufferMode = {
...
---How to decode a given LoveFileData.
FileDecoder = {
...
---The different modes you can open a LoveFile in.
FileMode = {
...
---@param size number @How many bytes to write.
---@return boolean, string
---@overload fun(name:string, data:LoveData, size:number):boolean, string
function m.append(name, data, size)
end

---Gets whether love.filesystem follows symbolic links.
---@return boolean
function m.areSymlinksEnabled()
end
...
---@return boolean
function m.createDirectory(name)
end

---Returns the application data directory (could be the same as getUserDirectory)
---@return string
function m.getAppdataDirectory()
end
...
function m.getDirectoryItems(dir)
end
...
function m.getInfo(path, filtertype)
end
...
---@return string
function m.getRealDirectory(filepath)
end
...
---@return string
function m.getSourceBaseDirectory()
end

---Returns the path of the user's directory
---@return string
function m.getUserDirectory()
end
...
---@return boolean
---@overload fun(filedata:LoveFileData, mountpoint:string, appendToPath:boolean):boolean
---@overload fun(data:LoveData, archivename:string, mountpoint:string, appendToPath:boolean):boolean
function m.mount(archive, mountpoint, appendToPath)
end

---Creates a new LoveFile object. 
---
---It needs to be opened before it can be accessed.
---@param filename string @The filename of the file.
---@return LoveFile
---@overload fun(filename:string, mode:FileMode):LoveFile, string
function m.newFile(filename)
end

---Creates a new LoveFileData object.
---@param contents string @The contents of the file.
---@param name string @The name of the file.
---@return LoveFileData
---@overload fun(filepath:string):LoveFileData, string
function m.newFileData(contents, name)
end
...
---@overload fun(container:ContainerType, name:string, size:number):LoveFileData or string, number, nil, string
function m.read(name, size)
end
...
function m.setCRequirePath(paths)
end
...
function m.setSymlinksEnabled(enable)
end
...
---@return boolean, string
---@overload fun(name:string, data:LoveData, size:number):boolean, string
function m.write(name, data, size)
end
