...
function m.fromPixels(pixelvalue)
end
...
---@return string
function m.getDisplayName(displayindex)
end
...
---@return boolean
function m.isDisplaySleepEnabled()
end
...
function m.requestAttention(continuous)
end
...
function m.setDisplaySleepEnabled(enable)
end
...
---@param imagedata LoveImageData @The window icon image.
---@return boolean
function m.setIcon(imagedata)
end
...
---@return boolean
function m.setMode(width, height, flags)
end
...
function m.setPosition(x, y, display)
end
...
function m.showMessageBox(title, message, type, attachtowindow)
end
...
---@return boolean
function m.updateMode(width, height, settings)
end
