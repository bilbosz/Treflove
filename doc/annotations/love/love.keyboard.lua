...
---@return KeyConstant
function m.getKeyFromScancode(scancode)
end
...
---@return Scancode
function m.getScancodeFromKey(key)
end

---Gets whether key repeat is enabled.
---@return boolean
function m.hasKeyRepeat()
end

---Gets whether text input events are enabled.
---@return boolean
function m.hasTextInput()
end
...
---@return boolean
function m.isScancodeDown(scancode, ...)
end
...
function m.setKeyRepeat(enable)
end
...
function m.setTextInput(enable)
end
