...
-- region LoveByteData
---@class LoveByteData
---LoveData object containing arbitrary bytes in an contiguous memory.
---
---There are currently no LÖVE functions provided for manipulating the contents of a LoveByteData, but LoveData:getPointer can be used with LuaJIT's FFI to access and write to the contents directly.
local LoveByteData = {}
-- endregion LoveByteData
-- region LoveData
---@class LoveData
...
---@return boolean
function m.hasDeprecationOutput()
end
...
function m.setDeprecationOutput(enable)
end
